...
@Composable
fun ClientsInBDScreen(
    viewModel: MainViewModel,
    navControllerTrainer: NavHostController
) {
    val listClientsVM: MutableList<UserModel>? by viewModel.listClientsBD.observeAsState(
        mutableListOf()
    )
            ...
            listClientsVM?.forEach {
                ...
                Card(modifier = Modifier
                    ...
                    Row(
                        ...
                        Column {
                            CellTittle(text = it.name_child + " " + it.secondName_child)
                        }
                    }
                }
                Card(
                    ...
                    Column(
                        ...
                        CellTittle(text = "(" + it.years + getYearString(
                            it.years.toInt()) + ")")
